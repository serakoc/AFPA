...
<!-- header contenant logo et phrase d'accroche (bootstrap) -->
    <header>
        <a href="index.html" title="logo accueil"  class=" col-md-6">
            <img src="../img/images/jarditou_logo.jpg" alt="Logo Jarditou" title="Logo Jarditou" class=" col-md-6"/>
        </a>
...
<!-- image de promotion-->
    <img src="../img/images/promotion.jpg" alt="promotion" title="promotion" id="promotion" class="img-fluid"/>
<?php 
    if (empty($_POST["nom"]) || empty($_POST["prenom"]) ||
     empty($_POST["sexe"]) || empty($_POST["email"]) || empty($_POST["demande"]))
    {
...
?>
  <footer>
    ...
    <script src="../js/contaxt.js"></script>
</body>
</html>
